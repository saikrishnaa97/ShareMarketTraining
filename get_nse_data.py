...
if request_uri == "/topGainers":
    ...
    if 'symbol' in query_params.keys():
        print(json.dumps(nse_data_helper.get_stock_status(query_params['symbol'][0]),indent=1))
    else:
        print(json.dumps({"error":"symbol is missing"},indent=1))
elif request_uri == "/niftyData":
    print(json.dumps(nse_data_helper.get_nse_status(),indent=1))
elif request_uri == "/search":
    if 'symbol' in query_params.keys():
        print(json.dumps(nse_data_helper.search_stock(query_params['symbol'][0]),indent=1))
    else:
        print(json.dumps({"error":"symbol is missing"},indent=1))
elif request_uri == "/indexData":
    if 'index' in query_params.keys():
        print(json.dumps(nse_data_helper.get_index_stocks(query_params['index'][0]),indent=1))
    else:
  ...
  if 'symbol' in query_params.keys() and 'weeks' in query_params.keys():
    print(json.dumps(nse_data_helper.get_nWeek_low(query_params['symbol'][0],int(query_params['weeks'][0])),indent=1))
  else:
      print(json.dumps({"error":"symbol and/or weeks are missing"},indent=1))
elif request_uri == "/nWeekHigh":
  if 'symbol' in query_params.keys() and 'weeks' in query_params.keys():
    print(json.dumps(nse_data_helper.get_nWeek_high(query_params['symbol'][0],int(query_params['weeks'][0])),indent=1))
  else:
      print(json.dumps({"error":"symbol and/or weeks are missing"},indent=1))
elif request_uri == "/historicalData":
    if 'symbol' in query_params.keys() and "from" in query_params.keys() and "to" in query_params.keys():
        print(json.dumps(nse_data_helper.get_historical_data(query_params['symbol'][0],query_params['from'][0],query_params['to'][0]),indent=1))
    else:
    ...
    if 'user_id' in query_params.keys():
        print(json.dumps(nse_data_helper.get_portfolio(query_params['user_id'][0]),indent=1))
    else:
